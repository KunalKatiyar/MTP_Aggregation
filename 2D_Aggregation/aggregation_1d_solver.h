...
class Aggregation_Solver_2d
{
    private:
        double r;
        int N0;
        double t_start, t_end;
        double v0, v_max, v_min, a0, m_max, m_min;
        vector<double> tspan;
    ...
    public:
        Aggregation_Solver_2d(double r, int N0, double t_start, double t_end, double a0, double v0, double v_max, double v_min,double m_max, double m_min);
